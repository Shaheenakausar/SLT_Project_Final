...
<body>
	<!-- <nav class="navbar navbar-primary navbar-fixed-top" id="my-navbar"> -->
	<nav id="navbar-red" class="navbar navbar-light navbar-fixed-top"
		style="background-color:	#E9967A" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="Home" class="navbar-brand">
					<img src="<c:url value="/resources/images/bouquet.jpg"/>" style="max-height: 50px; margin-top: -15px;" alt="logo" />
				</a>
			</div>
